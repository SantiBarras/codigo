...
def menu():
    ...
    texto=Label(ScrumP, text="Done", font=("Arial",30), bg="#6C13E7").place(x=490 , y= 140)

    #Tarea Finalizada
    hola1=Label(ScrumP, text="Tareas Finalizadas\n Numero de REFERENCIA:", font=("Arial",12), bg="#6C13E7").place(x=280 , y= 230)
    cuadro=Entry(ScrumP, font=("Arial",12), bg="#FFFFFF",width="9").place(x=330 , y= 280)
    boton=Button(ScrumP, text="Finalizar",font=("Arial",12),bg="#E0E2EE",width="9").place(x= 330, y= 310)
    hola1=Label(ScrumP, text="¡FELICIDADES\n no tienes tareas por realizar!", font=("Arial",12), bg="#6C13E7",width="21").place(x=280 , y= 350)
    fin=PhotoImage(file="finalizado.png")
    esqui1=Label(ScrumP,image=fin).place(x=310 , y= 400)

    #Ver tareas conjuntas
    hola1=Label(ScrumP, text="Ver tareas conjuntas\n REFERENCIA:", font=("Arial",12), bg="#6C13E7",width="21").place(x=600 , y= 230)
    cuadro=Entry(ScrumP, font=("Arial",12), bg="#FFFFFF",width="9").place(x=650 , y= 280)
    boton=Button(ScrumP, text="Visualizar",font=("Arial",12),bg="#E0E2EE",width="9").place(x= 650, y= 310)
    hola1=Label(ScrumP, text="¡Tu equipo no tiene\n tareas por realizar!", font=("Arial",12), bg="#6C13E7",width="21").place(x=600 , y= 350)
    
    bola=PhotoImage(file="bola.png")
    esqui2=Label(ScrumP,image=bola).place(x=650 , y= 410)
